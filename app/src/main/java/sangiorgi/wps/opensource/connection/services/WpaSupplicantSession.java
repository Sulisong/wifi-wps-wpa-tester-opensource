...
import sangiorgi.wps.opensource.connection.commands.CommandConfig;
import sangiorgi.wps.opensource.connection.commands.CommandFactory;
...
public class WpaSupplicantSession implements AutoCloseable {
  ...
  public void start() throws Exception {
    ...
    String supplicantCmd =
        new sangiorgi.wps.opensource.connection.commands.WpaSupplicantCommand(config)
            .buildCommand();
