package sangiorgi.wps.opensource.connection.handlers;
...
import sangiorgi.wps.opensource.connection.services.*;
...
public class ConnectionHandler {
  ...
  /**
   * Factory interface for creating ConnectionHandler instances. Hilt generates the implementation
   * automatically.
   */
  @AssistedFactory
  public interface Factory {
    ConnectionHandler create(
        ...
        @Assisted("stateManager") ConnectionStateManager stateManager,
        @Assisted("useOldMethod") boolean useOldMethod);
  }
  ...
  private void initializeConnection() {
    String title = context.getString(R.string.connessione) + " (Root)";
  ...
  private void handleTimeout(String pin) {
    ...
    runOnUiThread(
        () -> stateManager.updateProgress(context.getString(R.string.wpstimeout) + " " + pin));
  ...
  private void handleAllPinsExhausted() {
    String errorMessage = context.getString(R.string.failtoconn) + " " + networkToTest.getSsid();
